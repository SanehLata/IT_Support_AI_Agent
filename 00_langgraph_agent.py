...
docs = load_faq_csv("./it_helpdesk_qna.csv")
...
system_prompt = """You are a helpful IT Helpdesk Assistant with access to a knowledge base.
...
if __name__ == "__main__":
    result = agent.invoke({"messages": [("human", "laptop running too slow.")]})
